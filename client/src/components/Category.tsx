...
function Category( { props, showCatModal } : { props: CategoryProps, showCatModal: Function }  ) {
  ...
  return (
    <div className="w-28 h-32 border border-primary  rounded-lg mx-2 my-2 flex flex-col justify-center items-center cursor-pointer" onClick={ () => showCatModal(props.title) }>
